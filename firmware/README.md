...
The board has two USB ports: use USB-to-UART for flashing and logs, and USB-OTG for HID and WinUSB sync. The sync wire format is documented in [docs/protocol.md](../docs/protocol.md).
